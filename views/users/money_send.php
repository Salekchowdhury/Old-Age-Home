        ...
        <div class="wrapper ">
            ...
            <div class="main-panel">
                ...
                <div class="content">
                    ...
                    $data = $reg->userEmail($userEmail);
                    $referID = $dataManipulation->FindReferId($userEmail);
                    $referID = $referID->member_id;
                    ?>
                    <div class="row">
                        <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 pr-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" class="form-control" name="reference" value="<?php echo $referID?>">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 pr-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" disabled class="form-control" name="" placeholder="Reference" value="<?php echo $referID?>">
                                                </div>
                                            </div>
