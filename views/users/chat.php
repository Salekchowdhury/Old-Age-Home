    ...
    <div class="wrapper ">
        ...
        <div class="main-panel">
            ...
            <div class="content">
                ...
                $user_details = $reg->userEmail($_SESSION['email']);
                        ...
                        if ($list){
                            foreach ($list as $lists){
                                ...
                                <tr>
                                    ...
                                    <td class="attrName"><?php echo $lists->name ?><span class="message-show-on-alert badge-danger badge"></span></td>
                                    <td><?php echo $lists->type ?></td>
                                    <td><?php echo "0";echo $lists->phone ?></td>
                    ...
                    success:function (result) {
                        ...
                        for (var f = 0; f<ary.length; f++) {
                            for (var i = 0; i < datas.length; i++) {
                                if ((datas[i].messageRead == "unseen") && (datas[i].admin_id == ary[f]) ) {
                                    console.log(datas)
                                    $('.attrTable tr').each(function (a, b) {
                                        var name = $('.attrName', b).text();
                                        /*var value = $('.attrValue', b).attr('data-id');*/
                                        if($(".attrValue",b).attr('data-id') == datas[i].admin_id){
                                            console.log(datas[i].admin_id)
                                            j=j+1;
