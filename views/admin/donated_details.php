            ...
            <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand">Donated Details</a>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-header">
                                    ...
                                    <?php
                                    $data = $dataManipulation->totalAmount();
                                    $totalAmount = $data->total;
                                    ?>
                                    <div style="width: 300px; height: 50px; border-color: #1e7e34; border: 3px solid; border-radius: 15px" class="card-title">
                                        <strong style="color: #a71d2a;padding: 15px; font-size: 30px">BDT <b style="font-size: 27px; color: #1e7e34"> <?php echo $totalAmount?></b></strong>
                                    </div>
                                </div>
                                <table id="example1" class="table table-bordered table-hover">
                                    ...
                                    $data = $dataManipulation->donatedDetails();
                                    $S =1;
                                    if ($data){
                                        ...
                                        foreach ($data as $list){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <!--                                                        <a class="btn bg-success fancy" data-type="iframe" title="Gurdian Profile" href=""><i class="far fa-eye"></i></a>
                                                    -->                                                        <a href="view_membe_profiler.php?view_member_profile=<?php echo $list->reference?>" class="btn bg-primary fancy" data-type="iframe" title="Member Profile" ><i class="fa fa-eye"></i></a>
