            ...
            <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand">Trash List</a>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h3>Nurse/Doctor</h3>
                                    <?php
                                    if (isset($_SESSION["recoverNurseDoctorMsg"])){
                                        echo $_SESSION["recoverNurseDoctorMsg"];
                                        unset($_SESSION["recoverNurseDoctorMsg"]);
                                    }
                                    ?>
                                    <table id="example1" class="table table-bordered table-hover">
                                       ...
                                       <?php
                                       $data =$dataManipulation->showAllStatusNoNurseDoctorAcount();
                                       $s=1;
                                       foreach ($data as $list){
                                           ...
                                           <tr>
                                               ...
                                               <td>
                                                   ...
                                                   <a href="../dataprocess/process.php?recover_nurse_doctor=<?php echo $list->id?>" class="btn bg-success fancy" data-type="iframe" title="Confirm" ><i class="fas fa-trash-restore"></i> Recover</i></a>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h3>Users </h3>
                                    <?php
                                    if (isset($_SESSION["recoverUserMsg"])){
                                        echo $_SESSION["recoverUserMsg"];
                                        unset($_SESSION["recoverUserMsg"]);
                                    }
                                    ?>
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <?php
                                        $data =$dataManipulation->showAllStatusNoUserAcount();
                                        $s=1;
                                        foreach ($data as $list){
                                            ?>
                                            <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="../dataprocess/process.php?recover_user=<?php echo $list->id?>" class="btn bg-success fancy" data-type="iframe" title="Confirm" ><i class="fas fa-trash-restore"></i> Recover</i></a>
