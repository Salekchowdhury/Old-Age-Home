            ...
            <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand">Manage Account List</a>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <?php
                                    if (isset($_SESSION["moveMsg"])){
                                        echo $_SESSION["moveMsg"];
                                        unset($_SESSION["moveMsg"]);
                                    }
                                    ?>
                                    ...
                                    <table id="example1" class="table table-bordered table-hover">
                                        ...
                                        <?php
                                        $data =$dataManipulation->showAllActiveNurseDoctorAcount();
                                        $s=1;
                                        foreach ($data as $list){
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn bg-danger fancy" data-type="iframe" title="Trash" href="../dataprocess/process.php?move_to_nurse_doctor_acount=<?php echo $list->id?>"><i class="far fa-trash-alt"></i> Trash</a>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <?php
                                    if (isset($_SESSION["moveUserMsg"])){
                                        echo $_SESSION["moveUserMsg"];
                                        unset($_SESSION["moveUserMsg"]);
                                    }
                                    ?>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <?php
                                        $data =$dataManipulation->showAllActiveUserAcount();
                                        $s=1;
                                        foreach ($data as $list){
                                            ?>
                                            <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn bg-danger fancy" data-type="iframe" title="Trash" href="../dataprocess/process.php?move_to_user_acount=<?php echo $list->id?>"><i class="far fa-trash-alt"></i> Trash</a>
