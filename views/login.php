            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="../contents/images/oldAge.png" alt="sing up image"></figure>
                    ...
                    <div class="signin-form">
                        ...
                        <form action="dataprocess/registration_process.php" method="post" class="register-form" id="login-form">
                            ...
                            <div class="form-group form-button">
                               ...
                               <div class="col-6">
                                   <a href="forgot_password.php" name="forgot_password" class="form-submit btn w-100 bg-primary">Forgot Password</a>
