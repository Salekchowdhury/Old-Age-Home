...
if (isset($_SESSION['email'])){
    ...
    <div class="wrapper ">
        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="row">
                    <div class="col-md-9 wow slideInRight" data-wow-duration= "0.5s" data-wow-delay = "0.5s">
                            ...
                            <div style="border-radius: 15px; border: 2px solid;    margin-top: -20px; border-color: #a71d2a; box-shadow: 5px 10px 10px 2px black" class="tab-pane ">
                                <form class="form-horizontal" action="../dataprocess/process.php"  method="post">
                                    ...
                                    <div style="padding: 10px" class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <textarea class="col-8 m-3" cols="8" name="prescription" rows="5"><?php echo $prescription?></textarea>
                                        </div>
                                    ...
                                    <div class=" row">
                                        <div class="offset-sm-2 col-sm-10 ">
                                            ...
                                            if($data->health=='Critical'){
                                                ?>
                                                <button  name="normal_condition" class="btn bg-success fancy" data-type="iframe" >Normal</button>

                                                <?php
                                            }else{
                                                ?>
                                                <button  name="Critical_condition" class="btn bg-danger fancy" data-type="iframe" >Critical</button>
